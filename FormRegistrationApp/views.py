...
NAMA_MATA_KULIAH = (
    ("Cell Culture for Engineers",
     "Cell Culture for Engineers"), ("Chemical Engineering Mathematics",
                                     "Chemical Engineering Mathematics"),
    ("Chemical Engineering Thermodynamics",
     "Chemical Engineering Thermodynamics"), ("Chemical Process Simulation",
                                              "Chemical Process Simulation"),
    ("Chemical Reaction Engineering",
     "Chemical Reaction Engineering"), ("Engineering Economy",
                                        "Engineering Economy"),
    ("Fundamentals of Analytical Chemistry",
     "Fundamentals of Analytical Chemistry"), ("Fundamentals of Calculus",
                                               "Fundamentals of Calculus"),
    ("Fundamentals of Chemistry",
     "Fundamentals of Chemistry"), ("Fundamentals of Heat Transfer",
                                    "Fundamentals of Heat Transfer"),
    ("Fundamentals of Mass Transfer",
     "Fundamentals of Mass Transfer"), ("Fluid and Particles Mechanics",
                                        "Fluid and Particles Mechanics"),
    ("Fundamentals of Physics 1",
     "Fundamentals of Physics 1"), ("Fundamentals of Physics 2",
                                    "Fundamentals of Physics 2"),
    ("Mass and Energy Balances",
     "Mass and Energy Balances"), ("Numerical Computation for Engineers",
                                   "Numerical Computation for Engineers"),
    ("Organic Chemistry for Engineers",
     "Organic Chemistry for Engineers"), ("Process Control and Dynamics",
                                          "Process Control and Dynamics"),
    ("Physical Chemistry",
     "Physical Chemistry"), ("Product Design and Development",
                             "Product Design and Development"),
    ("Process Equipment Design",
     "Process Equipment Design"), ("Process Plant Design",
                                   "Process Plant Design"),
    ("Statistics and Probability",
     "Statistics and Probability"), ("Transport Phenomena",
                                     "Transport Phenomena"))
...
def metode_pembelajaran(request, email, nama_lengkap, nomor_telefon,
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            jumlah_sesi_yang_diikuti = form.cleaned_data[
        ...
        form = MetodePembelajaranForm(request.POST)
    return render(request, "FormRegistrationApp/metode_pembelajaran.html",
                  context)
            ...
            return HttpResponseRedirect(
                reverse(
                    ...
                    args=(email, nama_lengkap, nomor_telefon, program_studi,
                          ...
                          akun_discord_1, email_2, nama_lengkap_2,
                          nomor_telefon_2, akun_discord_2, email_3,
                          nama_lengkap_3, nomor_telefon_3, akun_discord_3,
                          email_4, nama_lengkap_4, nomor_telefon_4,
                          akun_discord_4, email_5, nama_lengkap_5,
                          nomor_telefon_5, akun_discord_5, email_6,
                          nama_lengkap_6, nomor_telefon_6, akun_discord_6,
                          email_7, nama_lengkap_7, nomor_telefon_7,
                          akun_discord_7, email_8, nama_lengkap_8,
                          nomor_telefon_8, akun_discord_8, email_9,
                          nama_lengkap_9, nomor_telefon_9, akun_discord_9,
                          email_10, nama_lengkap_10, nomor_telefon_10,
                          akun_discord_10)))
        else:
            return HttpResponseRedirect(
...
def anggota_kelompok_4(request, email, nama_lengkap, nomor_telefon,
                       ...
                       nama_lengkap_1, nomor_telefon_1, akun_discord_1,
                       email_2, nama_lengkap_2, nomor_telefon_2,
                       akun_discord_2, email_3, nama_lengkap_3,
...
def anggota_kelompok_5(request, email, nama_lengkap, nomor_telefon,
                       ...
                       email_2, nama_lengkap_2, nomor_telefon_2,
                       akun_discord_2, email_3, nama_lengkap_3,
                       nomor_telefon_3, akun_discord_3, email_4,
            ...
            return HttpResponseRedirect(
                reverse(
                    ...
                    args=(email, nama_lengkap, nomor_telefon, program_studi,
                          ...
                          email_4, nama_lengkap_4, nomor_telefon_4,
                          akun_discord_4, email_5, nama_lengkap_5,
                          nomor_telefon_5, akun_discord_5)))
...
def anggota_kelompok_6(
        ...
        akun_discord_3, email_4, nama_lengkap_4, nomor_telefon_4,
        akun_discord_4, email_5, nama_lengkap_5, nomor_telefon_5,
        akun_discord_5):
    if request.method == 'POST':
...
def anggota_kelompok_8(
        ...
        akun_discord_4, email_5, nama_lengkap_5, nomor_telefon_5,
        akun_discord_5, email_6, nama_lengkap_6, nomor_telefon_6,
        akun_discord_6, email_7, nama_lengkap_7, nomor_telefon_7,
        akun_discord_7):
    if request.method == 'POST':
            ...
            return HttpResponseRedirect(
                reverse(
                    ...
                    args=(email, nama_lengkap, nomor_telefon, program_studi,
                          ...
                          email_7, nama_lengkap_7, nomor_telefon_7,
                          akun_discord_7, email_8, nama_lengkap_8,
                          nomor_telefon_8, akun_discord_8)))
...
def anggota_kelompok_9(
        ...
        akun_discord_5, email_6, nama_lengkap_6, nomor_telefon_6,
        akun_discord_6, email_7, nama_lengkap_7, nomor_telefon_7,
        akun_discord_7, email_8, nama_lengkap_8, nomor_telefon_8,
        akun_discord_8):
    if request.method == 'POST':
...
def jadwal_belajar(request, email, nama_lengkap, nomor_telefon, program_studi,
                   ...
                   akun_discord_7, email_8, nama_lengkap_8, nomor_telefon_8,
                   akun_discord_8, email_9, nama_lengkap_9, nomor_telefon_9,
                   akun_discord_9, email_10, nama_lengkap_10, nomor_telefon_10,
                   akun_discord_10):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if 1 <= month_number <= 3:
                ...
                new_data.lampiran_invoice = "{}/invoice-q1/Inv/{}/{}/{}/{}/{}/".format(
                    domain, jumlah_peserta_invoice,
                    metode_pembelajaran_invoice, mata_kuliah_invoice,
                    registration_number_q1_invoice, quartal_invoice)
                new_data.lampiran_surat_tugas = "{}/invoice-assignment-q1/Inv/{}/{}/{}/{}/{}/".format(
                    domain, jumlah_peserta_invoice,
                    metode_pembelajaran_invoice, mata_kuliah_invoice,
                    registration_number_q1_invoice, quartal_invoice)
                ...
                invoice += "{}".format(str(year_number)[-2:])
                quartal_invoice += "{}".format(str(year_number)[-2:])
                new_data.lampiran_invoice = "{}/invoice-q2/Inv/{}/{}/{}/{}/{}/".format(
                    domain, jumlah_peserta_invoice,
                    metode_pembelajaran_invoice, mata_kuliah_invoice,
                    registration_number_q2_invoice, quartal_invoice)
                new_data.lampiran_surat_tugas = "{}/invoice-assignment-q2/Inv/{}/{}/{}/{}/{}/".format(
                    domain, jumlah_peserta_invoice,
                    metode_pembelajaran_invoice, mata_kuliah_invoice,
                    registration_number_q2_invoice, quartal_invoice)
                ...
                invoice += "{}".format(str(year_number)[-2:])
                quartal_invoice += "{}".format(str(year_number)[-2:])
                new_data.lampiran_invoice = "{}/invoice-q3/Inv/{}/{}/{}/{}/{}/".format(
                    domain, jumlah_peserta_invoice,
                    metode_pembelajaran_invoice, mata_kuliah_invoice,
                    registration_number_q3_invoice, quartal_invoice)
                new_data.lampiran_surat_tugas = "{}/invoice-assignment-q3/Inv/{}/{}/{}/{}/{}/".format(
                    domain, jumlah_peserta_invoice,
                    metode_pembelajaran_invoice, mata_kuliah_invoice,
                    registration_number_q3_invoice, quartal_invoice)
                ...
                invoice += "{}".format(str(year_number)[-2:])
                quartal_invoice += "{}".format(str(year_number)[-2:])
                new_data.lampiran_invoice = "{}/invoice-q4/Inv/{}/{}/{}/{}/{}/".format(
                    domain, jumlah_peserta_invoice,
                    metode_pembelajaran_invoice, mata_kuliah_invoice,
                    registration_number_q4_invoice, quartal_invoice)
                new_data.lampiran_surat_tugas = "{}/invoice-assignment-q4/Inv/{}/{}/{}/{}/{}/".format(
                    domain, jumlah_peserta_invoice,
                    metode_pembelajaran_invoice, mata_kuliah_invoice,
                    registration_number_q4_invoice, quartal_invoice)
            ...
            new_data.materi = str(materi).replace("[", "").replace("]",
                                                                   "").replace(
                                                                       "'", "")
            ...
            new_data.sesi_hari = str(form.cleaned_data['sesi_hari']).replace(
                "[", "").replace("]", "").replace("'", "")
            new_data.sesi_jam = str(form.cleaned_data['sesi_jam']).replace(
                "[", "").replace("]", "").replace("'", "")
            ...
            if int(jumlah_peserta) <= 3:
                ...
                biaya += ((250000 + ((int(jumlah_peserta) - 5) * 40000)) *
                          len(materi.split(",")))
            ...
            tanggal = str(
                datetime.datetime.now().strftime("%A")[0:3] + " " +
                datetime.datetime.now().strftime("%B")[:3] + " " +
                datetime.datetime.now().strftime("%d") + " " +
                datetime.datetime.now().strftime("%Y") + " " +
                datetime.datetime.now().strftime("%H:%M:%S GMT+0700 ") +
            ...
            try:
                ...
                if 1 <= month_number <= 3:
                    return HttpResponseRedirect(
                        reverse("send_email_q1",
                                args=(nama_lengkap, email, nomor_telefon,
                                      program_studi, universitas,
                                      metode_pembelajaran, mata_kuliah, materi,
                                      jumlah_peserta_invoice,
                                      metode_pembelajaran_invoice,
                                      mata_kuliah_invoice,
                                      registration_number_q1_invoice,
...
def invoice_q1(request, jumlah_peserta_invoice, metode_pembelajaran_invoice,
    ...
    if data.nama_lengkap_anggota_1 == "-" and data.nama_lengkap_anggota_2 == "-" and data.nama_lengkap_anggota_3 == "-" and data.nama_lengkap_anggota_4 == "-" and data.nama_lengkap_anggota_5 == "-" and data.nama_lengkap_anggota_6 == "-" and data.nama_lengkap_anggota_7 == "-" and data.nama_lengkap_anggota_8 == "-" and data.nama_lengkap_anggota_9 == "-" and data.nama_lengkap_anggota_10 == "-":
        ...
        daftar_anggota_kelompok += (
            data.nama_lengkap_anggota_1 + ", " + data.nama_lengkap_anggota_2 +
            ", " + data.nama_lengkap_anggota_3 + ", " +
            data.nama_lengkap_anggota_4 + ", " + data.nama_lengkap_anggota_5 +
            ", " + data.nama_lengkap_anggota_6 + ", " +
            data.nama_lengkap_anggota_7 + ", " + data.nama_lengkap_anggota_8 +
            ", " + data.nama_lengkap_anggota_9 + ", " +
            data.nama_lengkap_anggota_10).replace(", -", "")
    context = {
        'i': data,
    ...
    pdf = create_pdf_assignment('FormRegistrationApp/template_pdf.html',
                                context)
...
def invoice_q2(request, jumlah_peserta_invoice, metode_pembelajaran_invoice,
               mata_kuliah_invoice, registration_number_q4_invoice,
               quartal_invoice):
    data = RegistrationData.objects.get(
        nomor_invoice="Inv/{}/{}/{}/{}/{}".format(
...
def invoice_q3(request, jumlah_peserta_invoice, metode_pembelajaran_invoice,
               mata_kuliah_invoice, registration_number_q3_invoice,
               quartal_invoice):
    data = RegistrationData.objects.get(
        nomor_invoice="Inv/{}/{}/{}/{}/{}".format(
            jumlah_peserta_invoice, metode_pembelajaran_invoice,
...
def invoice_q4(request, jumlah_peserta_invoice, metode_pembelajaran_invoice,
               mata_kuliah_invoice, registration_number_q4_invoice,
               quartal_invoice):
    data = RegistrationData.objects.get(
        nomor_invoice="Inv/{}/{}/{}/{}/{}".format(
...
def invoice_assignment_q1(request, jumlah_peserta_invoice,
    ...
    data = RegistrationData.objects.get(
        nomor_invoice="Inv/{}/{}/{}/{}/{}".format(
            jumlah_peserta_invoice, metode_pembelajaran_invoice,
            mata_kuliah_invoice, registration_number_q1_invoice,
            quartal_invoice))
    ...
    pdf = create_pdf_assignment(
        'FormRegistrationApp/template_pdf_assignment.html', context)
    response = HttpResponse(pdf, content_type='application/pdf')
...
def invoice_assignment_q2(request, jumlah_peserta_invoice,
                          metode_pembelajaran_invoice, mata_kuliah_invoice,
                          registration_number_q2_invoice, quartal_invoice):
    data = RegistrationData.objects.get(
        nomor_invoice="Inv/{}/{}/{}/{}/{}".format(
            jumlah_peserta_invoice, metode_pembelajaran_invoice,
            mata_kuliah_invoice, registration_number_q2_invoice,
            quartal_invoice))
    sesi_hari = data.sesi_hari.replace("[", "").replace("]",
                                                        "").replace("'", "")
    sesi_jam = data.sesi_jam.replace("[", "").replace("]", "").replace("'", "")
...
def invoice_assignment_q3(request, jumlah_peserta_invoice,
                          metode_pembelajaran_invoice, mata_kuliah_invoice,
                          registration_number_q3_invoice, quartal_invoice):
    data = RegistrationData.objects.get(
        nomor_invoice="Inv/{}/{}/{}/{}/{}".format(
...
def invoice_assignment_q4(request, jumlah_peserta_invoice,
                          metode_pembelajaran_invoice, mata_kuliah_invoice,
                          registration_number_q4_invoice, quartal_invoice):
    data = RegistrationData.objects.get(
        nomor_invoice="Inv/{}/{}/{}/{}/{}".format(
...
def send_email_q2(request, nama_lengkap, email, nomor_telefon, program_studi,
                  universitas, metode_pembelajaran, mata_kuliah, materi,
                  jumlah_peserta_invoice, metode_pembelajaran_invoice,
                  mata_kuliah_invoice, registration_number_q2_invoice,
                  quartal_invoice):
...
def send_email_q3(request, nama_lengkap, email, nomor_telefon, program_studi,
                  universitas, metode_pembelajaran, mata_kuliah, materi,
                  jumlah_peserta_invoice, metode_pembelajaran_invoice,
                  mata_kuliah_invoice, registration_number_q3_invoice,
                  quartal_invoice):
...
def send_email_q4(request, nama_lengkap, email, nomor_telefon, program_studi,
                  universitas, metode_pembelajaran, mata_kuliah, materi,
                  jumlah_peserta_invoice, metode_pembelajaran_invoice,
                  mata_kuliah_invoice, registration_number_q4_invoice,
                  quartal_invoice):
